...
| `e3q-S928BXXU5DZDP` | Galaxy S24 Ultra `SM-S928B` | `6.1.145` | Offline ported; hardware validation pending |
...
make TARGET=e3q-S928BXXU5DZDP ANDROID_NDK_HOME=/path/to/android-ndk
```
...
The SM-S928B DZDP porting record is in
